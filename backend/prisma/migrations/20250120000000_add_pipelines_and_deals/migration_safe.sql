...
-- Use este SQL se a migration anterior falhou
...
-- Criar índices (IF NOT EXISTS não funciona em todas versões do PostgreSQL, então usamos DO)
DO $$ 
BEGIN
    -- Pipeline indexes
